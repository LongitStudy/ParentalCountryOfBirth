...
The Father branch contains syntax that derives three country of birth variables for the father of a new LS member (FAPLPRE92, FAPLFR92, FAPLFR07).

The Mother branch contains syntax that derives three country of birth variables for the mother of a new LS member (MOPLPRE92, MOPLFR92, MOPLFR07).
